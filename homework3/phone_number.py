...
['+380671234567', '+380952345678', '+380441234567', '+380501234567', '+380501233234',
...
def normalize_phone(raw_phone: str) -> str | None:
    ...
    # Normalize the phone number based on its length
    match len(phone_digits):
        case 12:
            phone = '+' + phone_digits
        case 11:
            phone = '+3' + phone_digits
        case 10:
            phone = '+38' + phone_digits
        case 9:
...
raw_numbers = [
    ...
    "38050-111-22-22",
    "38050 111 22 11   ",
    "38 bad 11   ",  # Invalid phone number
]

# Normalize phone numbers and filter out None values
sanitized_numbers = [num for num in (normalize_phone(num) for num in raw_numbers) if num is not None]
print("Нормалізовані номери телефонів для SMS-розсилки:", sanitized_numbers)
